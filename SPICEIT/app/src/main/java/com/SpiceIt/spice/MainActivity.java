...
public class MainActivity extends FragmentActivity {
	...
	static com.SpiceIt.spice.DBHelper dbhelper;
	AdapterMainMenu mma;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		dbhelper = new com.SpiceIt.spice.DBHelper(this);
	...
	private void displayView(int position) {
		...
		switch (position) {
			case 0:
				fragment = new com.SpiceIt.spice.ActivityHome();
				break;
			case 1:
				startActivity(new Intent(getApplicationContext(), com.SpiceIt.spice.ActivityCategoryList.class));
				overridePendingTransition(R.anim.open_next, R.anim.close_next);
				break;
			case 2:
				startActivity(new Intent(getApplicationContext(), com.SpiceIt.spice.ActivityCart.class));
				overridePendingTransition(R.anim.open_next, R.anim.close_next);
				break;

			case 4:
				startActivity(new Intent(getApplicationContext(), com.SpiceIt.spice.ActivityProfile.class));
				overridePendingTransition(R.anim.open_next, R.anim.close_next);
				break;
			case 5:
				startActivity(new Intent(getApplicationContext(), com.SpiceIt.spice.ActivityInformation.class));
				overridePendingTransition(R.anim.open_next, R.anim.close_next);
				break;
			case 6:
			...
			case 7:
				...
				sendInt.putExtra(Intent.EXTRA_TEXT, "Spice\n\"" + getString(R.string.app_name)
